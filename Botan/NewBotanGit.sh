...
if [ -d $HOME/Dev/GitRepos/botan/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/GitRepos/botan/*.* $HOME/Dev/GitRepos/botan/* $HOME/Dev/GitRepos/botan/
fi
