...
if [ -d $HOME/Dev/GitRepos/installer-framework/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/GitRepos/installer-framework/*.* $HOME/Dev/GitRepos/installer-framework/* $HOME/Dev/GitRepos/installer-framework/
fi
