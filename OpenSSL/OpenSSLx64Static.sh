...
# To write the Output into a Log File: 1>~/Dev/OpenSSLx64DebugStaticLog.txt 2>&1
...
# make --jobs=$(nproc) V=1 test 1>~/Dev/OpenSSLx64DebugStaticTestLog.txt 2>&1
...
make --jobs=1 V=1 install_sw
rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/OpenSSLx64Static/*.* $HOME/Dev/Builds/OpenSSLx64Static/* $HOME/Dev/Builds/OpenSSLx64Static/
echo DONE!
exit
