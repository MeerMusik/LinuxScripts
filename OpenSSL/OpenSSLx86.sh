...
if [ -d $HOME/Dev/Builds/OpenSSLx86/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/OpenSSLx86/*.* $HOME/Dev/Builds/OpenSSLx86/* $HOME/Dev/Builds/OpenSSLx86/
fi
if [ ! -d $HOME/Dev/Builds/OpenSSLx86/ ]; then cp --force --recursive --verbose $HOME/Dev/GitRepos/OpenSSL/ $HOME/Dev/Builds/OpenSSLx86/
fi
cd $HOME/Dev/Builds/OpenSSLx86/
...
make --jobs=1 V=1 install_sw
rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/OpenSSLx86/*.* $HOME/Dev/Builds/OpenSSLx86/* $HOME/Dev/Builds/OpenSSLx86/
exit
