...
cmake $HOME/Dev/GitRepos/llvm-project/llvm/ -G'Ninja' -DCMAKE_VERBOSE_MAKEFILE='ON' -DCMAKE_C_FLAGS_DEBUG='-D_FORTIFY_SOURCE=2 -D_GLIBCXX_ASSERTIONS -fasynchronous-unwind-tables -fexceptions -finput-charset=utf-8 -fno-lto -fno-omit-frame-pointer -fno-plt -fPIC -fno-semantic-interposition -frecord-gcc-switches -grecord-gcc-switches -m64 -pthread -Og -ggdb3 -pie -pipe -Wall -Wextra -Wl,-Og -Wl,-Bsymbolic-functions -Wl,--build-id=sha1 -Wl,--discard-locals -Wl,-fno-lto -Wl,-g -Wl,--hash-style=gnu -Wl,-z,combreloc -Wl,-z,noexecstack -Wl,-z,now -Wl,-z,relro -Wl,-z,separate-code -Wl,-z,text -Wl,-rpath=\$$ORIGIN/../lib' -DCMAKE_CXX_FLAGS_DEBUG='-D_FORTIFY_SOURCE=2 -D_GLIBCXX_ASSERTIONS -fasynchronous-unwind-tables -fexceptions -finput-charset=utf-8 -fno-lto -fno-omit-frame-pointer -fno-plt -fPIC -fno-semantic-interposition -fvisibility-inlines-hidden -frecord-gcc-switches -grecord-gcc-switches -m64 -pthread -Og -ggdb3 -pie -pipe -Wall -Wextra -Wl,-Og -Wl,-Bsymbolic-functions -Wl,--build-id=sha1 -Wl,--discard-locals -Wl,-fno-lto -Wl,-g -Wl,--hash-style=gnu -Wl,-z,combreloc -Wl,-z,noexecstack -Wl,-z,now -Wl,-z,relro -Wl,-z,separate-code -Wl,-z,text -Wl,-rpath=\$$ORIGIN/../lib' -DCMAKE_BUILD_TYPE='Debug' -DLLVM_ENABLE_PROJECTS='clang;clang-tools-extra;compiler-rt;lld;lldb' -DCMAKE_INSTALL_PREFIX=$HOME/Dev/Binaries/LLVMx64Debug/ -DLLVM_TARGETS_TO_BUILD='X86' -DLLVM_ENABLE_ASSERTIONS='ON' -DLLVM_ENABLE_EH='ON' -DLLVM_ENABLE_RTTI='ON' -DLLVM_ENABLE_TERMINFO='OFF' -DLLVM_INCLUDE_DOCS='OFF' -DLLVM_INCLUDE_EXAMPLES='OFF' -DLLVM_BUILD_TESTS='ON' -DLLVM_INCLUDE_TESTS='ON' -DLLVM_PARALLEL_LINK_JOBS=18 -DLLVM_USE_SPLIT_DWARF='ON'
