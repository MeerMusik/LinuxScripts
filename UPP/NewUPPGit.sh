...
if [ -d $HOME/Dev/GitRepos/ultimatepp/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/GitRepos/ultimatepp/*.* $HOME/Dev/GitRepos/ultimatepp/* $HOME/Dev/GitRepos/ultimatepp/
fi
