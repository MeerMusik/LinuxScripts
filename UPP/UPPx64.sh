...
# - CC0 1.0 Universal License Text End --Wl,-z,combreloc -Wl,-z,defs -Wl,-z,noexecstack -Wl,-z,now -Wl,-z,relro -Wl,-z,separate-code -Wl,-z,text
# --- Section to build Release Libraries ---1>/dev/null 2>&1
