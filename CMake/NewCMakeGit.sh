...
if [ -d $HOME/Dev/GitRepos/CMake/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/GitRepos/CMake/*.* $HOME/Dev/GitRepos/CMake/* $HOME/Dev/GitRepos/CMake/
fi
cd $HOME/Dev/GitRepos/
git clone https://github.com/Kitware/CMake.git --verbose --progress
echo DONE!
exit
