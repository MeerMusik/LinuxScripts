...
if [ -d $HOME/Dev/GitRepos/AKKomPolTool/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/GitRepos/AKKomPolTool/*.* $HOME/Dev/GitRepos/AKKomPolTool/* $HOME/Dev/GitRepos/AKKomPolTool/
fi
