...
export LDLIBS='/usr/i686-w64-mingw32/lib/libws2_32.a /usr/i686-w64-mingw32/lib/libcrypt32.a /usr/i686-w64-mingw32/lib/libadvapi32.a /usr/i686-w64-mingw32/lib/libgdi32.a /usr/i686-w64-mingw32/lib/libuser32.a'
...
if [ -d $HOME/Dev/Builds/LinWin/OpenSSLx86Static/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx86Static/*.* $HOME/Dev/Builds/LinWin/OpenSSLx86Static/* $HOME/Dev/Builds/LinWin/OpenSSLx86Static/
fi
if [ ! -d $HOME/Dev/Builds/LinWin/OpenSSLx86Static/ ]; then cp --force --recursive --verbose $HOME/Dev/GitRepos/openssl/ $HOME/Dev/Builds/LinWin/OpenSSLx86Static/
fi
cd $HOME/Dev/Builds/LinWin/OpenSSLx86Static/
# --- Section to build Debug Libraries ---
perl Configure CFLAGS='-D_FORTIFY_SOURCE=2 -D_GLIBCXX_ASSERTIONS -fasynchronous-unwind-tables -fcf-protection=branch -fexceptions -finput-charset=utf-8 -fno-lto -fno-omit-frame-pointer -fno-plt -fPIE -fstack-protector-all -fstack-clash-protection -frecord-gcc-switches -grecord-gcc-switches -m32 -mfunction-return=thunk -mindirect-branch=thunk -mindirect-branch-register -mshstk -pthread -Og -ggdb3 -pipe -std=gnu2x -static-libgcc -static-libstdc++ -static-pie -Wall -Walloc-zero -Wcast-align -Wconversion -Wdeprecated-declarations -Wdouble-promotion -Wduplicated-branches -Wduplicated-cond -Wextra -Wformat=2 -Wformat-nonliteral -Wformat-overflow=2 -Wformat-security -Wformat-truncation -Wimplicit-fallthrough -Wlogical-op -Wmisleading-indentation -Wmissing-declarations -Wnonnull -Wnull-dereference -Wpedantic -Wpointer-arith -Wshadow -Wsign-conversion -Wstack-protector -Wstrict-aliasing=2 -Wstrict-overflow -Wtrampolines -Wunused -Wvla -Wl,-Og -Wl,--allow-multiple-definition -Wl,--build-id=sha1 -Wl,--discard-locals -Wl,--dynamicbase -Wl,--enable-auto-image-base -Wl,-fno-lto -Wl,-g -Wl,-mi386pe -Wl,--large-address-aware -Wl,--nxcompat -Wl,-Bstatic -Wl,-static -Wl,--pie' no-shared --debug no-idea no-mdc2 no-rc5 no-comp no-deprecated no-engine no-static-engine no-weak-ssl-ciphers no-ssl3 no-ssl3-method no-tls1 no-tls1-method no-tls1_1 no-tls1_1-method no-dtls1 no-dtls1-method mingw --prefix=$HOME/Dev/Binaries/LinWin/OpenSSLx86DebugStatic/ --openssldir=$HOME/Dev/Binaries/LinWin/OpenSSLx86DebugStatic/
...
# To write the Output into a Log File: 1>~/Dev/OpenSSLx86DebugStaticWinLog.txt 2>&1 1>/dev/null 2>&1
make --jobs=$(nproc) V=1
...
perl Configure CFLAGS='-D_FORTIFY_SOURCE=2 -D_GLIBCXX_ASSERTIONS -fasynchronous-unwind-tables -fcf-protection=branch -fdata-sections -fexceptions -ffunction-sections -finput-charset=utf-8 -flto -fno-omit-frame-pointer -fno-plt -fPIE -fstack-protector-all -fstack-clash-protection -frecord-gcc-switches -grecord-gcc-switches -m32 -mfunction-return=thunk -mindirect-branch=thunk -mindirect-branch-register -mshstk -pthread -O3 -g0 -pipe -std=gnu2x -static-libgcc -static-libstdc++ -static-pie -Wall -Walloc-zero -Wcast-align -Wconversion -Wdeprecated-declarations -Wdouble-promotion -Wduplicated-branches -Wduplicated-cond -Wextra -Wformat=2 -Wformat-nonliteral -Wformat-overflow=2 -Wformat-security -Wformat-truncation -Wimplicit-fallthrough -Wlogical-op -Wmisleading-indentation -Wmissing-declarations -Wnonnull -Wnull-dereference -Wpedantic -Wpointer-arith -Wshadow -Wsign-conversion -Wstack-protector -Wstrict-aliasing=2 -Wstrict-overflow -Wtrampolines -Wunused -Wvla -Wl,-O3 -Wl,-Os -Wl,--allow-multiple-definition -Wl,--build-id=sha1 -Wl,--discard-locals -Wl,--dynamicbase -Wl,--enable-auto-image-base -Wl,-flto -Wl,--gc-sections -Wl,-s -Wl,-mi386pe -Wl,--large-address-aware -Wl,--nxcompat -Wl,-Bstatic -Wl,-static -Wl,--pie' no-shared --release no-idea no-mdc2 no-rc5 no-comp no-deprecated no-engine no-static-engine no-weak-ssl-ciphers no-ssl3 no-ssl3-method no-tls1 no-tls1-method no-tls1_1 no-tls1_1-method no-dtls1 no-dtls1-method mingw --prefix=$HOME/Dev/Binaries/LinWin/OpenSSLx86ReleaseStatic/ --openssldir=$HOME/Dev/Binaries/LinWin/OpenSSLx86ReleaseStatic/
echo Routing Output to /dev/null as the Terminal / Console is very slow to display the Output and refresh the Screen. Which will massively increase the build time. Please wait a Moment...
# To write the Output into a Log File: 1>~/Dev/OpenSSLx86ReleaseStaticWinLog.txt 2>&1 1>/dev/null 2>&1
make --jobs=$(nproc) V=1
make --jobs=$(nproc) test
echo Script paused for 10 Seconds to be able to read the Test Results! Please wait a Moment...
sleep 10s
...
sleep 10s
rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx86Static/*.* $HOME/Dev/Builds/LinWin/OpenSSLx86Static/* $HOME/Dev/Builds/LinWin/OpenSSLx86Static/
echo DONE!
exit
