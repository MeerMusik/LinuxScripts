...
if [ -d $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/*.* $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/* $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/
fi
if [ ! -d $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/ ]; then cp --force --recursive --verbose $HOME/Dev/GitRepos/openssl/ $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/
fi
cd $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/
...
sleep 10s
rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/*.* $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/* $HOME/Dev/Builds/LinWin/OpenSSLx86DebugStatic/
echo DONE!
