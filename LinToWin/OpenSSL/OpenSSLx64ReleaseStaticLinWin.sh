...
if [ -d $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/*.* $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/* $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/
fi
if [ ! -d $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/ ]; then cp --force --recursive --verbose $HOME/Dev/GitRepos/openssl/ $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/
fi
cd $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/
...
sleep 10s
rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/*.* $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/* $HOME/Dev/Builds/LinWin/OpenSSLx64ReleaseStatic/
echo DONE!
