...
if [ -d $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/ ]; then rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/*.* $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/* $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/
fi
if [ ! -d $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/ ]; then cp --force --recursive --verbose $HOME/Dev/GitRepos/openssl/ $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/
fi
cd $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/
...
sleep 10s
rm --interactive=never --dir --recursive --force --verbose $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/*.* $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/* $HOME/Dev/Builds/LinWin/OpenSSLx64Debug/
echo DONE!
