...
echo ONLY THE MANJARO SECTION HAS BEEN MODIFIED YET!
...
echo  DEP="apt-get install g++ clang make libgtk-3-dev libnotify-dev libbz2-dev libssl-dev xdotool" NOT PORTED YET!
